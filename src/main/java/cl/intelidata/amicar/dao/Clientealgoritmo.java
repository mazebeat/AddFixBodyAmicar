...
@XmlRootElement
@NamedQueries({@NamedQuery(name = "Clientealgoritmo.findAll", query = "SELECT c FROM Clientealgoritmo c"), @NamedQuery(name = "Clientealgoritmo.findByIdClienteAlgoritmo", query = "SELECT c FROM Clientealgoritmo c WHERE c.idClienteAlgoritmo = :idClienteAlgoritmo"), @NamedQuery(name = "Clientealgoritmo.findByIdCliente", query = "SELECT c FROM Clientealgoritmo c WHERE c.idCliente = :idCliente"), @NamedQuery(name = "Clientealgoritmo.findByIdBody", query = "SELECT c FROM Clientealgoritmo c WHERE c.idBody = :idBody")})
public class Clientealgoritmo implements Serializable {
	private static final long serialVersionUID = 1L;
	@Id @Basic(optional = false) @Column(name = "idClienteAlgoritmo", nullable = false)
	...
	public String toString() {
		return "cl.intelidata.amicar.dao.Clientealgoritmo[ idClienteAlgoritmo=" + idClienteAlgoritmo + " ]";
	}
